...
| Los puntos de entrada no se contradicen | `tests/test_arranque_en_frio.py` | Que un doc mande sacar la rama de un sitio y otro de otro: se arranca sin el trabajo bueno |
