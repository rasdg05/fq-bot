...
| 4 | NUPL throttle | **Gradiente monotónico perfecto**: capitulación +0.317 → codicia +0.072 (shorts al revés) · NUPL<0.5: uplift +0.029, DSR ✓, CPCV 80%>0 ✓, PBO no computable (régimen lento) · **PROTOCOLO RÉGIMEN-LENTO (2026-07-03: bootstrap de bloques + mitades): P(uplift>0)=0.941 < 0.95 ✗ y mitad 2019-22 ≈ +0.001** — el gradiente vive casi todo en 2023-26 | ⚠️ **NO cableable** — ni con el test correcto; NO es falta de cómputo, es falta de CICLOS. El unlock = forward + tiempo |
